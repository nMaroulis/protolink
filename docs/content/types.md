...
<ApiSurface
  ...
  cards={[
    ...
    {
      title: "Content",
      text: "Message roles, part types, MIME types, and reasoning levels make data models easier to validate.",
      code: "MimeType",
    },
    {
      title: "Control",
...
| **mock** | Deterministic mock LLM for tests and examples |
| **ollama** | Ollama local models |
| **openai-compatible** | Any server exposing `/v1/chat/completions` and `/v1/models` |
