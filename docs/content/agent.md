...
<div className="browser-surface-carousel" aria-label="Browser pages exposed by HTTP-compatible transports">
  <input className="browser-surface-carousel__state" type="radio" name="browser-surface" id="browser-surface-registry" defaultChecked />
  <input className="browser-surface-carousel__state" type="radio" name="browser-surface" id="browser-surface-agent" />
  <input className="browser-surface-carousel__state" type="radio" name="browser-surface" id="browser-surface-chat" />
  <div className="browser-surface-carousel__stage">
    <label className="browser-surface-card browser-surface-card--registry" htmlFor="browser-surface-registry" aria-label="Show registry status">
      ...
      <span className="browser-surface-card__caption">
        <strong>Registry status</strong>
        <span>Live registry identity and discovered agents.</span>
      </span>
    </label>
    <label className="browser-surface-card browser-surface-card--agent" htmlFor="browser-surface-agent" aria-label="Show agent status">
      <img src="https://raw.githubusercontent.com/nMaroulis/protolink/main/docs/assets/agent_status_card.png" alt="Agent status page" loading="lazy" />
      <span className="browser-surface-card__caption">
        <strong>Agent status</strong>
        <span>Agent card metadata, capabilities, transport, and skills.</span>
      </span>
    </label>
    <label className="browser-surface-card browser-surface-card--chat" htmlFor="browser-surface-chat" aria-label="Show agent chat">
      <img src="https://raw.githubusercontent.com/nMaroulis/protolink/main/docs/assets/agent_chat_card.png" alt="Agent chat page" loading="lazy" />
      <span className="browser-surface-card__caption">
        <strong>Agent chat</strong>
        <span>LLM-backed browser chat for development sessions.</span>
      </span>
    </label>
  </div>
  <div className="browser-surface-carousel__dots" aria-label="Carousel slides">
    <label htmlFor="browser-surface-registry" aria-label="Show registry status"></label>
    <label htmlFor="browser-surface-agent" aria-label="Show agent status"></label>
    <label htmlFor="browser-surface-chat" aria-label="Show agent chat"></label>
  </div>
</div>
